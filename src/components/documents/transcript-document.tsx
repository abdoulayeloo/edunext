...
type TranscriptData = NonNullable<
  Awaited<ReturnType<typeof import("@/data/transcript").getTranscriptData>>
>;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.studentInfoSection}>
          ...
          <Text style={styles.studentInfoText}>
            Formation : {fullFormationData.name}
          </Text>
        </View>
            ...
            {semester.ues.map((ue) => (
              <View key={ue.id} style={styles.ueTable}>
                ...
                <View style={styles.ueHeader}>
                  <Text style={{ ...styles.ueHeaderText, width: "60%" }}>
                    {ue.name}
                  </Text>
                  <Text
                    style={{
                ...
                <View style={styles.ueRow}>
                  ...
                  <Text
                    style={{
                      ...
                      textAlign: "center",
                      fontFamily: "Helvetica-Bold",
                      color: ue.isValidated ? "green" : "red",
                    }}
                  >
        ...
        <Text style={styles.footer} fixed>
          Généré le {new Date().toLocaleDateString("fr-FR")} - Document non
          contractuel
        </Text>
      </Page>
    </Document>
